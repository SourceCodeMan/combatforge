...
///   Build.bat PaintForgeServer Win64 Development -project=...
/// Same PaintForge module as the game client — no gameplay code changes.
/// </summary>
public class PaintForgeServerTarget : TargetRules
{
	public PaintForgeServerTarget(TargetInfo Target) : base(Target)
	{
