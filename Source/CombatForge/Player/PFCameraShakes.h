 ...
 * ACombatForgeCharacter on falls > 300 uu. Asset-free: the shake pattern is a
 * constructor-built default subobject.
 */
UCLASS()
class COMBATFORGE_API UPFLandShake : public UCameraShakeBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class COMBATFORGE_API UPFFireShake : public UCameraShakeBase
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class COMBATFORGE_API UPFHitTakenShake : public UCameraShakeBase
{
	GENERATED_BODY()
