...
public:
	...
	UFUNCTION(Server, Reliable) void ServerHostSetArenaMap(uint8 Map);      // Lobby only: 0=Warehouse 1=The Yard
...
protected:
	...
	void SpectateWhileDead(bool bForward);    // Fire=next, ADS=prev
