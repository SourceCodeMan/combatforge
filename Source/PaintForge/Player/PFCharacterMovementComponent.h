...
/**
 * PaintForge movement: sprint 830 / walk 600, ADS x0.55, custom CMOVE_Slide
...
class PAINTFORGE_API FSavedMove_PF : public FSavedMove_Character
{
public:
...
class PAINTFORGE_API FNetworkPredictionData_Client_PF : public FNetworkPredictionData_Client_Character
{
public:
