...
APFArenaShell::APFArenaShell()
{
	...
	// Arena art pack (CQB warehouse). Generated by Scripts/gen_arena_materials.py.
	// CDO FObjectFinder is fine for /Game once the assets exist and are cooked with the project.
